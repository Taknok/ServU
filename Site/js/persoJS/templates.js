            ...
            "<div class='btn-group-in-footer btn-group btn-group-justified'>" +
                ...
                "<div class='btn-group dropdown'>" +
                    ...
                    "<ul class='dropdown-menu' id='actionList#"+id+"'>" +
                        "<li>" +
                            "<a data-toggle='modal' data-target='#actionModal' onclick='changeActionModal(\""+username+"\",\""+id+"\",\"ring\")'>" +
                        ...
                        "</li>" +
                        "<li>" +
                            "<a data-toggle='modal' data-target='#actionModal' onclick='changeActionModal(\""+username+"\",\""+id+"\",\"vibrate\")'>" +
                        ...
                        "</li>" +
                        "<li>" +
                            "<a data-toggle='modal' data-target='#actionModal' onclick='changeActionModal(\""+username+"\",\""+id+"\",\"flashlight\")'>" +
